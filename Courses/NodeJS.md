...
- [Node.js in 2021: новости платформы и вызовы на следующее десятилетие](https://youtu.be/nnB7ADYso8s) 👁️‍🗨️ check it real quick
...
- [Node.js в 2019 году](https://youtu.be/CUU49jjHloM) 👁️‍🗨️ check it real quick
...
- [Настройка среды: Node.js, npm, git, eslint](https://youtu.be/hSyA7tcNaCE) ⬜ - that was in the past course
...
- [Консоль и командная строка в JavaScript и Node.js](https://youtu.be/5aSZyKi5BmE)  ⬜ - that was in the past course
  - Примеры кода: https://github.com/HowProgrammingWorks/CommandLine

## Структура и архитектура приложений на Node.js

- [Архитектурный подход к программированию](https://youtu.be/d_vyO2CkiOc) 👁️‍🗨️ check it real quick
...
- [Слои, связанность и связность кода](https://youtu.be/A3RpwNlVeyY) 👁️‍🗨️ check it real quick
  - Примеры кода: https://github.com/HowProgrammingWorks/Abstractions
- [GRASP принципы с адаптацией для JavaScript и Node.js](https://youtu.be/ExauFjYV_lQ) 👁️‍🗨️ check it real quick
- [Принцип информационный эксперт / Information Expert](https://youtu.be/cCHL329_As0) 👁️‍🗨️ check it real quick
- [Зацепление и связность / coupling and cohesion](https://youtu.be/IGXdPOZ3Fyk) 👁️‍🗨️ check it real quick
- [Чистая выдумка / Pure Fabrication](https://youtu.be/CV577a0RHBM) 👁️‍🗨️ check it real quick
- [GRASP: Пример декомпозиции класса](https://youtu.be/4AMVQ2-2DcM) 👁️‍🗨️ check it real quick
...
- [HTTP запросы в браузере и Node.js: XMLHttpRequest, fetch](https://youtu.be/wMMki2FEYGY)  👁️‍🗨️ check it real quick
  - Примеры кода: https://github.com/HowProgrammingWorks/HttpRequest
- [Разработка API на Node.js (клиент и сервер)](https://youtu.be/-az912XBCu8) 👁️‍🗨️ check it real quick
  - Примеры кода: https://github.com/HowProgrammingWorks/API
- [WebSocket сервер на Node.js (электронные таблицы и чат)](https://youtu.be/Sf7ln3n16ws) 👁️‍🗨️ check it real quick
  - Вебсокеты: https://github.com/HowProgrammingWorks/WebsocketChat
  - Чат: https://github.com/HowProgrammingWorks/LiveTable
- [Скаффолдинг для API, UI и данных](https://youtu.be/lipkLQVqDd8) 👁️‍🗨️ check it real quick
  - Примеры кода: https://github.com/HowProgrammingWorks/Scaffolding
- [Высоконагруженные распределенные приложения на Node.js](https://youtu.be/7tfZDABPvVs) 👁️‍🗨️ check it real quick
- [Отдача статики в Node.js](https://youtu.be/n_AdKIzbpBc) 👁️‍🗨️ check it real quick
...
- [Паттерн Команда (Command) действие и параметры как объект](https://youtu.be/vER0vYL4hM4) 👁️‍🗨️ check it real quick
  - Этот паттерн понадобится для следующей лекции
  - Примеры кода: https://github.com/HowProgrammingWorks/Command
- [CQS, CQRS, Event Sourcing - Разделение запросов и модификации данных](https://youtu.be/T2tRc80Q8Qw) 👁️‍🗨️ check it real quick
...
- [Применение EventSourcing](https://youtu.be/kFNtKiK2SPs) 👁️‍🗨️ check it real quick
...
- [Утечки памяти в Node.js и JavaScript, сборка мусора и профилирование](https://youtu.be/0oZa64SB2wM) 👁️‍🗨️ check it real quick
  - Примеры кода: https://github.com/HowProgrammingWorks/MemoryLeaks
- [Atomics, SharedArrayBuffer, worker_threads в Node.js](https://youtu.be/zLm8pnbxSII) 👁️‍🗨️ check it real quick
  - Потоки: https://github.com/HowProgrammingWorks/Threads/
  - Атомарные операции: https://github.com/HowProgrammingWorks/Atomics/
- [Семафоры и мьютексы в JavaScript и Node.js](https://youtu.be/JNLrITevhRI) 👁️‍🗨️ check it real quick
  - Семафоры: https://github.com/HowProgrammingWorks/Semaphore
  - Мьютексы: https://github.com/HowProgrammingWorks/Mutex
- [Разделяемая память в многопоточном Node.js](https://youtu.be/KNsm_iIQt7U) 👁️‍🗨️ check it real quick
доклад на конференции JS Fest 2019 Spring
  - Слайды: https://www.slideshare.net/JSFestUA/js-fest-2019-nodejs
- [Web Locks API in Node.js and browser](https://youtu.be/auMM-uV12F0) 👁️‍🗨️ check it real quick
...
- [Проблема асинхронного стектрейса в JavaScript и Node.js](https://youtu.be/pfiHTx3j87Y) 👁️‍🗨️ check it real quick
...
- [Serverless Clouds (FaaS) и изоляция контекстов запросов в Node.js](https://youtu.be/x-Rd6fPV6L8) 👁️‍🗨️ check it real quick
  - Слайды: https://www.slideshare.net/tshemsedinov/serverless-clouds-faas-and-request-context-isolation-in-nodejs

## Вспомогательные темы

- [Асинхронный пул для worker thread pool в Node.js](https://youtu.be/Jj5KZRq4wYI)  ⬜ - that was in the past course
